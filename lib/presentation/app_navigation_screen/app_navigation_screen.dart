                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildScreenTitle(
                          screenTitle: "Task Details".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.taskDetailsScreen),
                        ),
                        _buildScreenTitle(
                          screenTitle: "Messages - Container".tr,
                        ...
                        _buildScreenTitle(
                          screenTitle: "Message Groups".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.messageGroupsScreen),
                        ),
                        _buildScreenTitle(
                          screenTitle: "New Message".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.newMessageScreen),
                        ),
                        _buildScreenTitle(
                          screenTitle: "Create New Task".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.createNewTaskScreen),
                        ),
                        _buildScreenTitle(
